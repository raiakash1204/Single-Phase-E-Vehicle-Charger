...
#include "EVC_e9d0b336_49_ds_dxicr_p.h"
#include "EVC_e9d0b336_49_ds.h"
#include "EVC_e9d0b336_49_ds_externals.h"
#include "EVC_e9d0b336_49_ds_external_struct.h"
#include "ssc_ml_fun.h"
int32_T EVC_e9d0b336_49_ds_dxicr_p ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * out ) { static int32_T
_cg_const_1 [ 50 ] = { 0 , 0 , 0 , 0 , 1 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2
, 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 ,
2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 , 2 } ; ( void
) t1 ; out -> mDXICR_P . mNumCol = 49ULL ; out -> mDXICR_P . mNumRow = 14ULL
; out -> mDXICR_P . mJc [ 0 ] = _cg_const_1 [ 0 ] ; out -> mDXICR_P . mJc [ 1
...
49 ] = _cg_const_1 [ 49 ] ; out -> mDXICR_P . mIr [ 0 ] = 12 ; out ->
mDXICR_P . mIr [ 1 ] = 13 ; ( void ) sys ; ( void ) out ; return 0 ; }
